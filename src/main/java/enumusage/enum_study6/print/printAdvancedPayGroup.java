package enumusage.enum_study6.print;
...
public enum printAdvancedPayGroup implements PayGroupInterface {
    ...
    printAdvancedPayGroup(String title, List<PayType> payList){
        this.title = title;
        this.payList = payList;
    }

    public static printAdvancedPayGroup findByPayCode(PayType code){
        return Arrays.stream(printAdvancedPayGroup.values())
